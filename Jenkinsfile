...
stage('Deploy') {
steps {
sh '/Applications/Docker.app/Contents/Resources/bin/docker-compose/docker-compose
up -d --build'
}
}
...
sh "/Applications/Docker.app/Contents/Resources/bin/docker tag evalspringse:latest
ngorseck/evalspringse:v1"
sh "/Applications/Docker.app/Contents/Resources/bin/docker push
abdou0008/evalspringse:v1"
}
}
}
}
